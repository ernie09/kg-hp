          ...
          <ul className="nav navbar-nav navbar-right">
            ...
            <li className="dropdown">
              <a
                ...
                aria-haspopup="true"
                aria-expanded="false">
                  Der Verein<span className="caret"></span>
              </a>
              <ul className="dropdown-menu">
                ...
                <li>
                  <a
                    href="/dl/Beitrittserklaerung-BeitragsEinzugsFormular_SEPA.pdf"
                    target="_blank" rel="noopener noreferrer">Mitgliedsantrag</a>
                </li>
                <li role="separator" className="divider"></li>
                <li>
