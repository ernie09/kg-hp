...
class Historie extends Component<HistorieProps> {

  constructor(props: HistorieProps) {
    super(props);
  }
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <p className="medium">Im Jahre 1929 setzten sich für die damaligen Verhältnisse 11 mutige Männer zusammen einen Verein zu gründen. Sie machten sich zur Aufgabe das Geschehen von “Hüh” und “Scheldche” an den Tag zu bringen. Im denkwürdigem Jagdhaus wurde der Entschluss
                  ...
                  Siebenmorgen Hermann Klöckner und Willi Hessler. Die Vorleser (heute Präsident) waren Lorens Seger sowie Anton Müller, die nicht zu zimperlich die lokalen Ereignisse wahrheitsgetreu vortrugen inkl. den dazugehörigen Namen. Im Gasthaus Stüber
                  brachte man den sogenannten “Kummerkasten” an, in den jeder seine Verse einwerfen konnte, ohne zu wissen von wem die einzelnen Büttenrden waren. Sonntagsabend war dann Kappensitzung mit 40 Pfennig Eintritt plus einem Papierhut für 10 Pfennig
                  als “Eintrittskarte”. Dieser mußte weiterverkauft werden, sobald der Betroffene ihn wieder absetzte und statt Hut bekam er einen Stempel auf die Hand. Der Erlös kam der KG zu Gute. Es war immer viel los im Hühsches Karneval aber Geld in der
                ...
                <p className="medium">Womit niemand rechnete, die selbstständigen Händler und Handwerker mußte den Verein verlassen, da sie um ihre Existenz fürchteten. Sie bekamen zu hören “Verkauft Eure Zeug an den Narrenclub!” Da es nicht an Nachwuchs fehlte ging
                  ...
                  zum Lachen gebracht, bis schließlich der Kummerkasten im Vereinslokal entfernt wurde und die Dichter ihre eigenen Reden vortrugen. Damals so wie heute drängten immer mehr Jugendliche in den Verein, was nach wie vor von großer Bedeutung ist.
                  Neue Ideen und Konzepte wurden vorgestellt, versucht und teils heute noch vorhanden, wie der Umzug am Karnevalssonntag indem das Prinzenpaar proklamiert wurde. Ein neuer Präsident wurde gewählt, Hans Holl. Es folgten ihm Hans Linsler, Josef
                  Müller, Hans Holl erneut, Willibald Brücken, Manfred Buhr, Albert Giritsch und derzeit Oliver Meier-Ronfeld. Der Verein fand zu einer Satzung in welcher sich neue Mitglieder verpflichteten einmal den Prinz zu machen als auch eine
                ...
                <p className="medium">
                  ...
                  Michael Reitz. Gleichzeitig wurde eine Internetpräsenz im weltweiten Computernetzwerk aufgebaut. Unter “www.mir-hale-pool.de” kann sich nun die ganze Welt einen Einblick in den Karneval ob Hüh und Scheldche verschaffen dank dem vereinseigenen
                  Administrator Marco Wagner. Im darauffolgenden Jahr 2006 erstmals ein Prinz aus Elsbach, Uwe und Tanja Lenz. Der Aktionsradius der KG erweitere sich. Somit beginnt die “heiße Phase” der KG schon mittwochs mit dem Besuch der Möhnen in Breitscheid.
                </p>
              </div>
            </div>
          </div>
