        ...
        <div className="timeline">
          ...
          <article className="panel panel-danger">
            ...
            <div className="panel-heading">
              <h2 className="panel-title">Prinzenpaar &amp; Kinderprinzessin 2020 auf Hüh und Scheldche</h2>
            </div>
            <div className="panel-body">
              {/* Am vergangenen Samstag war es endlich soweit. Unsere karnvalistische Session 2020 startete mit der Kappensitzung. Wir freuen uns auf eine tolle Session mit unseren Tollitäten:
                <Panel>
                  <Panel.Heading>
              ...
              <br />
                    Bilder und ein Bericht der Kappensitzung folgen.
            </div>
            <div className="panel-footer">
              <small><strong>Verscheid, Januar 2020</strong></small>
            </div>
          </article>
