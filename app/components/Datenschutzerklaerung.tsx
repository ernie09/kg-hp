...
const Datenschutzerklaerung: React.FC<DatenschutzerklaerungProps> = () => {
  return <>
    ...
    />
    <Container text>
      <Header as="h3">I.Name und Anschrift des Verantwortlichen</Header>
    ...
    <Container text>
      <Header as="h3">II. Allgemeines zur Datenverarbeitung</Header>
      <Header as="h5">1. Umfang der Verarbeitung personenbezogener Daten:</Header>
      <p>
        ...
        <br />Bei jedem Abruf unseres Internetauftritts werden Zugriffsdaten wie aufgerufene Seiten,
        Namen der abgerufenen Dateien, Name des Internet Service Providers sowie Beschreibung des
        Webbrowsers und des Betriebssystems mit Zugriffsdatum und -uhrzeit gespeichert. Diese Informationen
        dienen einer statistischen Auswertung ohne Personenbezug. Durch die Nutzung unseres
        Internetangebots erklären Sie sich damit einverstanden. Unter <b>„personenbezogene Daten“</b> sind
        alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person beziehen,
        insbesondere Vor- und Nachname, Geburtsdatum, E-Mail-Adresse, Wohn-Adresse, sowie Bank- und
        Zahlungsdaten, aber auch Gesundheitsdaten, zu verstehen, vgl. Art. 4 Nr. 1 DS-GVO (Einzelangaben
        über eine bestimmte oder bestimmbare natürliche Person gemäß § 3 Abs. 1 BDSG).
      </p>
      <Header as="h5">2. Rechtsgrundlage für die Verarbeitung personenbezogener Daten:</Header>
      <p>
        ...
        erforderlich ist, der unser Unternehmen unterliegt, dient Art. 6 Abs. 1 lit. c DSGVO als Rechtsgrundlage.<br />
      ...
      <Header as="h5">3. Datenlöschung und Speicherdauer:</Header>
      <p>
        ...
        der Verantwortliche unterliegt, vorgesehen wurde. Eine Sperrung oder Löschung der Daten erfolgt auch dann,
    ...
    <Container text>
      <Header as="h3">III. Bereitstellung der Website und Erstellung von Logfiles</Header>
      <Header as="h5">1. Beschreibung und Umfang der Datenverarbeitung:</Header>
      <p>
      ...
      <Header as="h5">2. Rechtsgrundlage für die Datenverarbeitung:</Header>
      <p>
          Rechtsgrundlage für die vorübergehende Speicherung der Daten und der Logfiles ist Art. 6 Abs. 1 lit. f DSGVO.
      </p>
      <Header as="h5">3. Zweck der Datenverarbeitung:</Header>
      <p>
        Die vorübergehende Speicherung der IP-Adresse durch das System ist notwendg, um eine Auslieferung der Website
        an den Rechner des Nutzers zu ermöglichen. Hierfür muss die IP-Adresse desNutzers für die Dauer der Sitzung
      ...
      <Header as="h5">4. Dauer der Speicherung:</Header>
      <p>
      ...
      <Header as="h5">5. Widerspruchs- und Beseitigungsmöglichkeit:</Header>
      <p>
    ...
    <Container text>
      <Header as="h3">IV. Google +, Facebook und Twitter</Header>
      <p>
        Schließlich verwenden wir auch Social Media Kanäle wie Google +, Facebook und Twitter. Über diese Plugins
        bieten wir dem Nutzer die Möglichkeit unsere Website auch mit anderen Nutzern zu teilen.<br />
        Wenn der Nutzer auf das entsprechende Icon klickt wird automatisch eine Verbindung zu Facebook bzw. zu
        einem der anderen Dienste hergestellt und die Inhalte dieser Seite geladen. Eine vollumfängliche Nutzung
        der Seite ist allerdings nur bei Bestehen eines Accounts bei dem jeweiligen Dienst möglich.<br />
        Auf ihren Internetseiten stellen Facebook, Google + und Twitter detaillierte Angaben zu Umfang, Art, Zweck
        und Weiterverarbeitung der Daten zur Verfügung. Wir haben in diesem Zusammenhang keinen Einfluss auf den
        Inhalt der Plugins und die Informationsübermittlung.
      </p>
    </Container>
    <Container text>
      <Header as="h3">V. Rechte der betroffenen Person</Header>
      <p>
      ...
      <ol>
        <li>Auskunftsrecht:</li>
          ...
          betreffen, von uns verarbeitet werden. Liegt eine solche Verarbeitung vor, können Sie von dem
        ...
        <ol>
          ...
          <li>die geplante Dauer der Speicherung der Sie betreffenden personenbezogenen Daten oder, falls konkrete
            Angaben hierzu nicht möglich sind, Kriterien für die Festlegung der Speicherdauer;</li>
          ...
          <li>alle verfügbaren Informationen über die Herkunft der Daten, wenn die personenbezogenen Daten nicht bei
            der betroffenen Person erhoben werden;</li>
          <li>das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Art. 22 Abs. 1
            ...
            sowie die Tragweite und die angestrebten Auswirkungen einer derartigen Verarbeitung für die
            betroffene Person.
          </li>
        </ol>
        ...
        <li>
          ...
          <ol>
            <li>wenn Sie die Richtigkeit der Sie betreffenden personenbezogenen für eine Dauer bestreiten, die es
              dem Verantwortlichen ermöglicht, die Richtigkeit der personenbezogenen Daten zu überprüfen;</li>
          ...
          verarbeitet werden. Wurde die Einschränkung der Verarbeitung nach den o.g. Voraussetzungen eingeschränkt,
        ...
        <li>
          ...
          <ul>
            ...
            <ol>
              ...
              <li>
                Sie widerrufen Ihre Einwilligung, auf die sich die Verarbeitung gem. Art. 6 Abs. 1 lit. a oder Art.
            ...
            <li>Information an Dritte<br />
              ...
              um für die Datenverarbeitung Verantwortliche, die die personenbezogenen Daten verarbeiten, darüber zu
            ...
            <li>Ausnahmen<br />
              ...
              <ol>
                ...
                <li>
                  aus Gründen des öffentlichen Interesses im Bereich der öffentlichen Gesundheit gemäß Art. 9 Abs. 2
        ...
        <li>
          Recht auf Unterrichtung: <br />Haben Sie das Recht auf Berichtigung, Löschung oder Einschränkung der
          Verarbeitung gegenüber dem Verantwortlichen geltend gemacht, ist dieser verpflichtet, allen Empfängern, denen
          die Sie betreffenden personenbezogenen Daten offengelegt wurden, diese Berichtigung oder Löschung der Daten
          oder Einschränkung der Verarbeitung mitzuteilen, es sei denn, dies erweist sich als unmöglich oder ist mit
        ...
        <li>Recht auf Datenübertragbarkeit:<br />Sie haben das Recht, die Sie betreffenden personenbezogenen Daten, die
        Sie dem Verantwortlichen bereitgestellt haben, in einem strukturierten, gängigen und maschinenlesbaren Format
        zu erhalten. Außerdem haben Sie das Recht diese Daten einem anderen Verantwortlichen ohne Behinderung durch den
        ...
        <li>
          Widerspruchsrecht:<br />Sie haben das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben,
          ...
          Profiling. Der Verantwortliche verarbeitet die Sie betreffenden personenbezogenen Daten nicht mehr, es sei
          denn, er kann zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die Ihre Interessen, Rechte und
          ...
          mit solcher Direktwerbung in Verbindung steht. Widersprechen Sie der Verarbeitung für Zwecke der
          Direktwerbung, so werden die Sie betreffenden personenbezogenen Daten nicht mehr für diese Zwecke verarbeitet.
        ...
        <li>Automatisierte Entscheidung im Einzelfall einschließlich Profiling:<br />
          ...
          <ol>
            ...
            genannten Fälle trifft der Verantwortliche angemessene Maßnahmen, um die Rechte und Freiheiten sowie Ihre
            berechtigten Interessen zu wahren, wozu mindestens das Recht auf Erwirkung des Eingreifens einer Person
            seitens des Verantwortlichen, auf Darlegung des eigenen Standpunkts und auf Anfechtung der Entscheidung
            gehört.
        </li>
        <li>Recht auf Beschwerde bei einer Aufsichtsbehörde:<br />
            ...
            Verarbeitung der Sie betreffenden personenbezogenen Daten gegen die DSGVO verstößt. Die Aufsichtsbehörde,
            bei der die Beschwerde eingereicht wurde, unterrichtet den Beschwerdeführer über den Stand und die
            Ergebnisse der Beschwerde einschließlich der Möglichkeit eines gerichtlichen Rechtsbehelfs nach
            Art. 78 DSGVO.
        </li>
      </ol>
    </Container>
