...
interface DatenschutzerklaerungProps {}

/**
 *
 */
class Datenschutzerklaerung extends Component<DatenschutzerklaerungProps> {

  /**
   *
   */
  constructor(props: DatenschutzerklaerungProps) {
    super(props);
  }
